/* Gamepak ROM page-cache allocation (total megabytes). Override before including
 * this header or pass -DROM_BUFFER_SIZE=N on the compiler command line. */
#ifndef ROM_BUFFER_SIZE
#define ROM_BUFFER_SIZE 8
#endif
